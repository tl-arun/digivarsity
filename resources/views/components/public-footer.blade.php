    ...
    <div class="container mx-auto px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
                <div class="flex items-center space-x-3 mb-6">
                    ...
                    <h3 class="text-2xl font-bold gradient-text">Digivarsity</h3>
                </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li><a href="/#universities" class="text-gray-400 hover:text-white transition-colors">Universities</a></li>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-gray-400">info@digivarsity.com</span>
                    </li>
                    <li class="flex items-start space-x-3">
        ...
        <div class="border-t border-gray-800 pt-8 text-center">
            <p class="text-gray-400">
                &copy; {{ date('Y') }} Digivarsity. All rights reserved.
            </p>
        </div>
    </div>
</footer>
