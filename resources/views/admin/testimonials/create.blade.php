            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="before_role" id="before_role" value="{{ old('before_role') }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="after_role" id="after_role" value="{{ old('after_role') }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-1 flex items-center">
                            <div id="preview" class="hidden mr-4">
                                <img id="preview-image" src="" alt="Preview" class="h-24 w-24 rounded-full object-cover border border-gray-300">
                            </div>
