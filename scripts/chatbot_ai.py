...
class ConversationalChatbot:
    ...
    def _should_show_programs(self, message: str) -> bool:
        ...
        # Only show programs if user explicitly asks with these specific phrases
        show_patterns = [
            'show me program', 'show program', 'show all program',
            'list program', 'list all program',
            'display program', 'display all program',
            'see program', 'see all program',
            'view program', 'view all program',
            'find program', 'search program',
            'give me program', 'recommend program',
            'available program', 'what program do you have',
            'which program do you have'
        ]

        # Check if message contains any of these specific patterns
